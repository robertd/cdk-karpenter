...
import { Cluster, HelmChart, ICluster, KubernetesVersion } from 'aws-cdk-lib/aws-eks';
...
export class Karpenter extends Construct {
  ...
  constructor(scope: Construct, id: string, props: IKarpenterProps) {
    ...
    // // Karpenter at 0.5.3 does not currently support a flag that enables boottime disk encryption
    // // So in CDK we generate a launch template that follows the Kubernetes version we use.
    // const blockDeviceOS: BlockDevice = {
    //   deviceName: '/dev/xvda',
    //   volume: BlockDeviceVolume.ebs(2, {
    //     encrypted: true,
    //   }),
    // };
    // const blockDeviceImages: BlockDevice = {
    //   deviceName: '/dev/xvdb',
    ...
    //     kubernetesVersion: props.k8sVersion.version,
    //   }),
    //   userData,
